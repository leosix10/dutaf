...
<head>
    ...
    <title>DUTAF | Supression Auteur</title>
...
<section class="container py-5">
    <div class="row text-center pt-3">
        ...
        <h1 class="h1">Supression d'un auteur</h1>
        ...
        $req = 'DELETE FROM auteur WHERE auteur_id = '.$num_aut;
        $exe = $bdd->query($req); //l auteur est maintenant supprimée
        ?>
        <p>Vous venez de supprimer l'auteur.</p>
        <p>
        <a href="aut_gestion.php">Revenir à la liste des auteurs</a>
        </p>
    </div>
