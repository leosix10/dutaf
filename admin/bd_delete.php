...
<head>
    ...
    <title>DUTAF | Supression Album</title>
...
<section class="container py-5">
    <div class="row text-center pt-3">
        ...
        <h1 class="h1">Supression d'un album</h1>
        ...
        $req = 'DELETE FROM album WHERE album_id = '.$num_bd;
        $exe = $bdd->query($req); //la BD est maintenant supprimée
        ?>
        <p>Vous venez de supprimer la BD.</p>
        <p>
            <a href="bd_gestion.php">Revenir à la liste des albums</a>
        </p>
    </div>
