...
<head>
    ...
    <title>DUTAF | Supression Editeur</title>
...
<section class="container py-5">
    <div class="row text-center pt-3">
        ...
        <h1 class="h1">Supression d'un éditeur</h1>
        ...
        $num_edit = $_GET['num_edit'];

        $req = 'DELETE FROM editeur WHERE editeur_id = '.$num_edit;
        $exe = $bdd->query($req); //l editeur est maintenant supprimée
        ?>
        <p>Vous venez de supprimer l'éditeur.</p>
        <p>
            <a href="editeur_gestion.php">Revenir à la liste des éditeurs</a>
        </p>
    </div>
