...
<head>
    ...
    <title>DUTAF | Confirmation éditeur</title>
...
<section class="container py-5">
    <div class="row text-center pt-3">
        ...
        <h1 class="h1">Confirmation éditeur modifié</h1>
        ...
        $req = 'UPDATE editeur SET editeur_nom = "'.$_POST['nom'].'", editeur_pays = "'.$_POST['pays'].'", editeur_tel = "'.$_POST['telephone'].'" WHERE editeur_id='.$_POST['num_edit'];
        ...
        <p><a href="editeur_gestion.php">Revenir à la liste des éditeurs</a></p>
    </div>
