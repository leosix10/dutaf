...
<head>
    ...
    <title>DUTAF | Confirmation auteur</title>
...
<section class="container py-5">
    <div class="row text-center pt-3">
        ...
        <h1 class="h1">Confirmation auteur modifié</h1>
        ...
        $req = 'UPDATE auteur SET auteur_nom = "'.$_POST['nom'].'", auteur_prenom = "'.$_POST['prenom'].'", auteur_nat = "'.$_POST['nation'].'", auteur_age = "'.$_POST['age'].'" WHERE auteur_id='.$_POST['num_aut'];
